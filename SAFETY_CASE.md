...
This repository addresses agent services, backend systems, firmware-facing components, external actions, and active integrations. Unless a release states otherwise with reproducible evidence, its components are research, prototype, documentation, or simulation artifacts and are not approved for safety-critical production use.
