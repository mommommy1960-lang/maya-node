...
This repository covers agent services, backend systems, firmware-facing components, external actions, and active integrations. This document establishes a baseline and must be revised as architecture and evidence change.
